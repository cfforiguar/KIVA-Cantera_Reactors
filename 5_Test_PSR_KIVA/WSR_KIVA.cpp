...
int wrapper_c_()
{
	...
	*/
	...
	ins[0]=797.44343300028004;//temperatura [k];
	ins[1]=1.8262142783018984470754111821574e-12;//CellVolume[m3];
	ins[2]=2.9524885687824536114931106567383e+08;//CellPressure[Pa];
	ins[3]=3.9094599031019848e-06;//tfinal[s];
	ins[4]=6.0011245170067728856657266365857e-06;//fuel_mdot[kg/s];

	for (k = 0; k < nsp; k++) {
            salida[k]= 0.0;
        }
	salida[0]=6.117728072246902131771766742624e-11;//C7H16
	salida[1]=0.23199999998580663755516115580698;//O2
	salida[2]=0.76799999995301603988464993389757;//N2
